...
def build_zavuch_manual():
    ...
    add_numbered(doc, 'Логинҳои завуч ба шакли zavuch_M{id} мебошанд, масалан zavuch_M1 барои муассисаи №1.')
    ...
    add_table(doc, ['Рол', 'Логин (намуна)', 'Рамз (намуна)'], [
        ['Маориф мудир', 'director', 'Director_2026'],
        ['Завуч / Ҳамоҳангсоз', 'zavuch_M1', 'Zavuch_M1@2026'],
        ['Омӯзгор', 'teacher_M1_1', 'Teacher_M1_1@2026'],
    ])
    ...
    add_numbered(doc, 'Омӯзгор бо логини худ (teacher_M{id}_{counter}) ворид мешавад.')
