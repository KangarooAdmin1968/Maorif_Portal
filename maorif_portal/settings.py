...
TJC_SUBJECTS = {
    ...
    '9': ["Забони тоҷикӣ", "Адабиёти тоҷик", "Забони русӣ", "Забони англисӣ", "Алгебра", "Геометрия", "Физика", "Химия", "Биология", "География", "Таърихи халқи тоҷик", "Таърихи умумӣ", "Таърихи дин", "Асосҳои давлат ва ҳуқуқи Ҷумҳурии Тоҷикистон", "Технологияи иттилоотӣ", "Технология", "Нақшакашӣ", "Соати тарбиявӣ"],
    '10': ["Забони тоҷикӣ", "Адабиёти тоҷик", "Забони русӣ", "Забони англисӣ", "Алгебра", "Геометрия", "Физика", "Химия", "Биологияи умумӣ", "География", "Таърихи халқи тоҷик", "Таърихи умумӣ", "Ҳуқуқи инсон", "Маърифати оиладорӣ", "Технологияи иттилоотӣ", "Технология", "Тарбияи ҷисмонӣ", "Омодагии ибтидоии ҳарбӣ", "Адабиёти ҷаҳон", "Соати тарбиявӣ"],
