...
urlpatterns = [
    ...
    path('school/<int:school_id>/class/add/', views.add_class, name='add_class'),
    ...
    path('school/<int:school_id>/class/<str:class_name>/transfer/', views.transfer_class, name='transfer_class'),
